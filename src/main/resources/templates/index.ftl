...
<div id="layout">
  <div id="header">
    <div class="headerNav">
      <label style="font-size: 30px; font-family: 华文楷体;color: #ffffff;">放疗信息管理</label>
      <ul class="nav">
  ...
  <div id="leftside">
    ...
    <div id="sidebar">
      <div class="toggleCollapse"><h2>放疗信息管理系统</h2>
        <div>收缩</div>
      </div>
        ...
        <div class="accordionContent">
          <ul class="tree treeFolder">
            ...
            <li>
              <a>前台</a>
              <ul>
                <li><a href="patient/list" target="navTab" rel="patient">登记</a></li>
                <li><a href="patient/list" target="navTab" rel="patient">搜索</a></li>
                <li><a href="">患者到检（签到）</a></li>
                <li><a href="">患者叫号</a></li>
                <li><a href="">划价收费</a></li>
                <li><a href="">完成治疗</a></li>
              </ul>
            ...
            <li>
              ...
              <ul>
                <li><a href="patient/list" target="navTab" rel="patient">登记</a></li>
                <li><a href="">医生门诊病历</a></li>
                <li><a href="">问诊</a></li>
                <li><a href="">开医嘱</a></li>
                <li><a href="">定位（常规模拟机定位、CT模拟机定位）</a></li>
                <li><a href="">勾画靶区及危机器官</a></li>
                <li><a href="">靶区确认</a></li>
                <li><a href="">计划申请</a></li>
                <li><a href="">计划评估确认</a></li>
                <li><a href="">约复位和首次治疗</a></li>
                <li><a href="">放疗治疗单</a></li>
                <li><a href="">放疗小结</a></li>
              </ul>
            </li>
            <li>
      ...
      <div class="navTab-panel tabsPageContent layoutBox">
        <div class="page unitBox">
          <div class="accountInfo">
            ...
            <p><span style="font-size: 30px; text-align: center; padding-top: 10px;">欢迎使用放疗信息管理系统</span></p>
